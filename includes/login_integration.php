 ...
 *
 * Replaces default WordPress login with social authentication
 *
 * @package HotSoup
 * @since 0.37
 */
...
function hs_redirect_to_custom_login() {
    ...
    // Don't redirect if already on custom login page
...
/**
 * Add social authentication buttons to WordPress login page
 * (Alternative to full redirect - adds buttons to default wp-login.php)
 */
...
/**
 * Enqueue scripts on WordPress login page
 */
