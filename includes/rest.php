...
function gread_register_rest_routes() {
    ...
    // Note: /books/{id} endpoint is in includes/api/book-details.php
 ...
 // --- Inaccuracy Reporter Routes ---
    ...
    // Note: Series and Reviews endpoints are now in separate API files:
    // - includes/api/series.php (Series CRUD operations)
    // - includes/api/reviews.php (Reviews and ratings)
    // - includes/api/book-details.php (Enhanced /books/{id} endpoint)
...
// Note: Enhanced book details endpoint moved to includes/api/book-details.php
// Available at GET /books/{id}
...
// Note: Series and Reviews callback functions have been moved to:
// - includes/api/series.php
// - includes/api/reviews.php
